...
public final class Queen extends Piece {
    public Queen(@NotNull Board board, @NotNull Color color) {
        super(board, color);
    }

    private void checkDirection(boolean[][] moves, @NotNull Position currentPosition, int rowIncrement, int colIncrement) {
        Position newPosition = new Position(currentPosition.getRow() + rowIncrement, currentPosition.getColumn() + colIncrement);
